...
export abstract class ModerationComand<T = unknown> extends FutabaCommand {
	// Whether a member is required or not
	public requiredMember: boolean

	protected constructor(context: PieceContext, options: ModerationComand.Options) {
		super(context, {
			cooldownDelay: 5000,
...
export namespace ModerationComand {
